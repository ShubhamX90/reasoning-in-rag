#!/usr/bin/env python3
"""
TEXT-MODE Generator v5 (ORACLE baseline variant)
------------------------------------------------
...
- This script runs the **BASELINE** model only (NO LoRA / fine-tuned adapter).
...
Example:
  python code/eval/generate_textmode_v5_oracle_baseline.py \
    ...
    --out_jsonl outputs/test_generations_v5.1_qwen_oracle/sft_baseline_qwen_v5.1.test_v5.1_oracle.raw.jsonl \
...
def main():
    ...
    # Base model ONLY (baseline, no LoRA)
    ...
    print(f"[ORACLE-BASELINE] Wrote → {out_path}")
